...
export class GpuDispatcher {
     ...
     */
    public async dispatch(t: number = 0, kernels: Record<string, string>, encoder?: GPUCommandEncoder): Promise<GPUCommandEncoder> {
        ...
        this.stagingManager.updateStaging(t, rules, faceMappings);
